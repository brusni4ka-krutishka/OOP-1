...
namespace Lab2
{
    class Program
    {
        ...
        {   //1a
            ...
            bool var_bool = true;
            byte var_byte = 234; //0-255
            sbyte var_sbyte = -120; //-128-127
            char var_char = 'c';
            decimal var_decimal = 9517m; //28-29 digits
            double var_double = 1.678; //`15-17 digits
            float var_float = 1.2f; //`6-9 digits
            int var_int = -54;
            uint var_uint = 54; //unsigned
            long var_long = 54654847; //-9,223,372,036,854,775,808 to 9,223,372,036,854,775,807
            ulong var_ulong = 9865435465;//0 to 18,446,744,073,709,551,615
            short var_short = -30000; //-32,768 to 32,767
            ushort var_ushort = 30000; //0 to 65,535

            //Встроенные ссылочные типы
            object ref_object = 3u;
            string ref_string = "String";
            dynamic ref_dynamic = 1;
            Console.WriteLine($"{var_bool}, {var_byte}, {var_double}, {var_short}");
            ...
            //2d
            StringBuilder newstr = new StringBuilder("hi i'm Eugene");
